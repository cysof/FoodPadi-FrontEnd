    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 py-10 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          {/* Why Choose Us */}
          <div className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-6 text-center">Why Choose FoodBank?</h2>
          ...
          <div className="bg-primary rounded-xl shadow-md p-8 text-center text-white">
            ...
            <p className="mb-6 opacity-90">Join thousands of users already using FoodBank</p>
